...
df = pd.read_excel('datasets/normalized_selected_data_2.xlsx')
...
selected_features_df.to_excel('datasets/selected_features_2.xlsx', index=False)
...
selected_data.to_excel('datasets/selected_data_2.xlsx', index=False)
