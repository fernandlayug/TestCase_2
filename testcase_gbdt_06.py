...
data = pd.read_excel('datasets/selected_data_top_contributing_features.xlsx')
...
joblib.dump(scaler, 'model/scaler_6.pkl')
joblib.dump(encoder, 'model/encoder_6.pkl')
...
scaler_data.to_excel('model/scaler_6.xlsx', index=False)
...
encoder_df.to_excel('model/encoder_6.xlsx', index=False)
...
joblib.dump(best_xgb, 'model/best_xgb_model_16.pkl')
