...
joblib.dump(scaler, 'model/scaler_7.pkl')
joblib.dump(encoder, 'model/encoder_7.pkl')
...
scaler_data.to_excel('model/scaler_7.xlsx', index=False)
...
encoder_df.to_excel('model/encoder_7.xlsx', index=False)
...
joblib.dump(best_xgb, 'model/best_xgb_model_17.pkl')
